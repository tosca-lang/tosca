...
public class TSParser extends org.antlr.v4.runtime.Parser implements Parser, Cloneable
{
	...
	/** 
	 * Prefix added to each enumeration values
	 */
	...
	/**
	 * Initialize lexer state before parsing.
	 * Do nothing by default. Generated parser can override
	 */
	protected void initLexerState(String category)
	{}
	...
	/**
	 * Whether to send types or not. For meta-parsing only.
	 * Useful for meta parsers not generated by Tosca.
	 * @return
	 */
	protected boolean sendTypes()
	{
		return true;
	}
