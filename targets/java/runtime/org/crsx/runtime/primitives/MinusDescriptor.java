...
/**
 * $[Minus, #number1, #number2] is the subtraction of 2 numbers. 
 *	
 *  @author Lionel Villard
 */
public class MinusDescriptor extends ConstructionDescriptor
{
	@Override
	...
	public boolean step(Sink sink, Term term)
	{
		...
		assert term.arity() == 3 : "$[Minus, #number1, #number2] : missing argument.";
		...
		if (!Construction.isConstant(num1) ||  !Construction.isConstant(num2))
			throw new RuntimeException("Invalid argument in Minus");
