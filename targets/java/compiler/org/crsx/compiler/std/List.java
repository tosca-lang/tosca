		...
		if (sink.context().sd++ < 256)
		{
			...
			label_55 :
			{
				...
				Term jterm_89;
				{
					...
					Variable jvar_37 = buffer_80.context().makeVariable("x");
					buffer_80.binds(new Variable[]
						{jvar, jvar_37});
					Term jterm_62;
					{
						BufferSink buffer_7 = buffer_80.context().makeBuffer();
						buffer_7.use(jvar);
						jterm_62 = buffer_7.term();
					}
					Term jterm_49;
					{
						BufferSink buffer_25 = buffer_80.context().makeBuffer();
						buffer_25.use(jvar_37);
						jterm_49 = buffer_25.term();
					}
					buffer_80.substitute(term.ref(), new Variable[]
						{var, var_77}, new Term[]
						{jterm_62, jterm_49});
					buffer_80.copy(term_50.ref());
					buffer_80.copy(sub_55.ref());
					buffer_80.end();
	...
	final public static boolean _M_Map(Sink sink, Variable var_98, Term term_75, Term term_18)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_48 :
			{
				...
				Term jterm_25;
				{
					BufferSink buffer_42 = sink.context().makeBuffer();
					buffer_42.copy(sub_78.ref());
					jterm_25 = buffer_42.term();
				}
				sink.substitute(term_75.ref(), new Variable[]
					{var_98}, new Term[]
					{jterm_25});
				sink.start(_M_Map);
	...
	final public static boolean _M_Filter(Sink sink, Variable var_53, Term term_46, Term term_92)
	{
		if (sink.context().sd++ < 256)
		{
			label_79 :
			{
				...
				Term jterm_29;
				{
					BufferSink buffer_37 = sink.context().makeBuffer();
					buffer_37.use(jvar_90);
	...
	final public static boolean _M_MapM(Sink sink, Variable var_69, Variable var_17, Term term_52, Term term_62, Term term_55)
	{
		if (sink.context().sd++ < 256)
		{
			label_19 :
			{
				...
				Variable jvar_77 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_15, jvar_77});
				Term jterm_55;
				{
					BufferSink buffer_55 = sink.context().makeBuffer();
					buffer_55.use(jvar_15);
					jterm_55 = buffer_55.term();
				}
				Term jterm_96;
				{
					BufferSink buffer_77 = sink.context().makeBuffer();
					buffer_77.use(jvar_77);
					jterm_96 = buffer_77.term();
				}
				sink.substitute(term_52.ref(), new Variable[]
					{var_69, var_17}, new Term[]
					{jterm_55, jterm_96});
	...
	final public static boolean _M_RemoveDuplicates(Sink sink, Term term_77)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_26 :
			{
				...
				sink.start(_M_Filter);
				Variable jvar_99 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_99});
				sink.start(_M_Not);
				sink.start(_M_Equal);
	...
	final public static boolean _M_MapM2(Sink sink, Variable var_81, Variable var_52, Term term_73, Term term_38, Term term_97, Term term_81)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_67 :
			{
				...
				Term jterm_33;
				{
					BufferSink buffer_87 = sink.context().makeBuffer();
					buffer_87.copy(term_38.ref());
					jterm_33 = buffer_87.term();
				}
				Term jterm_1;
				{
					BufferSink buffer_70 = sink.context().makeBuffer();
					buffer_70.copy(sub_29.ref());
					jterm_1 = buffer_70.term();
				}
				sink.substitute(term_73.ref(), new Variable[]
					{var_81, var_52}, new Term[]
					{jterm_33, jterm_1});
				...
				Term jterm_63;
				{
					BufferSink buffer_34 = sink.context().makeBuffer();
					buffer_34.use(jvar_16);
					jterm_63 = buffer_34.term();
				}
				Term jterm_14;
				{
					BufferSink buffer_93 = sink.context().makeBuffer();
					buffer_93.use(jvar_67);
		...
		if (sink.context().sd++ < 256)
		{
			label_81 :
			{
				...
				Term jterm_28;
				{
					...
					buffer_13.use(jvar_5);
					jterm_28 = buffer_13.term();
				}
				Term jterm_3;
				{
					BufferSink buffer_90 = sink.context().makeBuffer();
					buffer_90.use(jvar_91);
					jterm_3 = buffer_90.term();
				}
				sink.substitute(term_13.ref(), new Variable[]
					{var_72, var_57}, new Term[]
					{jterm_28, jterm_3});
				sink.copy(sub_3.ref());
	...
	final public static boolean _M_PickFirst1(Sink sink, Term term_194, Term term_17, Term term_96, Variable var_1, Term term_65)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_62 :
			{
				...
				Variable jvar_251 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_251});
				Term jterm_42;
				{
					BufferSink buffer_35 = sink.context().makeBuffer();
					buffer_35.use(jvar_251);
	...
	final public static boolean _M_Foldl(Sink sink, Variable var_102, Variable var_195, Term term_39, Term term_66, Term term_98)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_76 :
			{
				...
				Variable jvar_1 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_195, jvar_1});
				Term jterm_66;
				{
					BufferSink buffer_61 = sink.context().makeBuffer();
					buffer_61.use(jvar_195);
					jterm_66 = buffer_61.term();
				}
				Term jterm_138;
				{
					BufferSink buffer_76 = sink.context().makeBuffer();
					buffer_76.use(jvar_1);
					jterm_138 = buffer_76.term();
				}
				sink.substitute(term_39.ref(), new Variable[]
					{var_102, var_195}, new Term[]
					{jterm_66, jterm_138});
				Term jterm_93;
				{
					BufferSink buffer_91 = sink.context().makeBuffer();
					buffer_91.copy(sub_90.ref());
					jterm_93 = buffer_91.term();
				}
				Term jterm_31;
				{
					BufferSink buffer_2 = sink.context().makeBuffer();
					buffer_2.copy(term_66.ref());
	...
	final public static boolean _M_IfEmpty(Sink sink, Term term_54, Term term_93, Term term_3)
	{
		if (sink.context().sd++ < 256)
		{
			label_90 :
			{
				...
				/* #1=term */ /* #2=term */ sink.copy(term_93.ref());
				return true;
			}
			label_24 :
			{
				...
				/* #s=sub */
				/* #1=term */ /* #2=term */ sink.copy(term_3.ref());
				return true;
			}
		}
	...
	final public static boolean _M_Head(Sink sink, Term term_148)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_82 :
			{
				...
				/* #=sub */
				Term sub_124 = term_148.sub(1).ref();
				/* #s=sub */ sink.copy(sub_56.ref());
				return true;
			}
		}
		...
		if (sink.context().sd++ < 256)
		{
			label_46 :
			{
				...
				Term jterm_32;
				{
					...
					buffer_20.use(jvar_87);
					jterm_32 = buffer_20.term();
				}
				sink.substitute(term_90.ref(), new Variable[]
					{var_108}, new Term[]
					{jterm_32});
				sink.use(jvar_87);
				sink.use(jvar_19);
		...
		if (sink.context().sd++ < 256)
		{
			...
			label_69 :
			{
				...
				Term jterm_86;
				{
					...
					buffer_36.copy(sub_87.ref());
					jterm_86 = buffer_36.term();
				}
				Term jterm_76;
				{
					BufferSink buffer_46 = sink.context().makeBuffer();
					buffer_46.copy(sub_126.ref());
					jterm_76 = buffer_46.term();
				}
				sink.substitute(term_67.ref(), new Variable[]
					{var_15, var_27}, new Term[]
					{jterm_86, jterm_76});
	...
	final public static boolean _M_IfSingleton(Sink sink, Term term_33, Term term_133, Term term_70)
	{
		if (sink.context().sd++ < 256)
		{
			label_190 :
			{
				...
				/* #1=term */ /* #2=term */ sink.copy(term_70.ref());
				return true;
			}
			label_56 :
			{
	...
	final public static boolean _M_Tail(Sink sink, Term term_125)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_157 :
			{
				...
				/* #=sub */
				Term sub_131 = term_125.sub(1).ref();
				/* #s=sub */ sink.copy(sub_131.ref());
				return true;
			}
		}
	...
	final public static boolean _M_Map2(Sink sink, Variable var_76, Term term_47, Term term_205)
	{
		if (sink.context().sd++ < 256)
		{
			label_2 :
			{
				...
				Variable jvar_27 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_38, jvar_27});
				...
				Term jterm_46;
				{
					...
					buffer_63.use(jvar_38);
					jterm_46 = buffer_63.term();
				}
				sink.substitute(term_47.ref(), new Variable[]
					{var_76}, new Term[]
					{jterm_46});
				sink.use(jvar_27);
				sink.end();
	...
	final public static boolean _M_Intersect(Sink sink, Term term_193, Term term_68)
	{
		if (sink.context().sd++ < 256)
		{
			label_57 :
			{
				...
				Variable jvar_32 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_93, jvar_32});
				sink.start(_M_ConditionalInsert);
				sink.start(_M_Elem);
	...
	final public static boolean _M_Concat(Sink sink, Term term_25, Term term_16)
	{
		if (sink.context().sd++ < 256)
		{
			label_80 :
			{
				...
				/* #tail=term */ sink.copy(term_16.ref());
				return true;
			}
			label_29 :
			{
	...
	final public static boolean _M_Elem(Sink sink, Term term_29, Term term_161)
	{
		if (sink.context().sd++ < 256)
		{
			label_91 :
			{
				...
				Variable jvar_131 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_23, jvar_131});
				sink.start(_M_Or);
				sink.start(_M_Equal);
	...
	final public static boolean _M_Union(Sink sink, Term term_109, Term term_44)
	{
		if (sink.context().sd++ < 256)
		{
			label_61 :
			{
				...
				sink.start(_M_RemoveDuplicates);
				sink.start(_M_Concat);
				sink.copy(term_109.ref());
				sink.copy(term_44.ref());
				sink.end();
				sink.end();
				return true;
			}
	...
	final public static boolean _M_ConditionalInsert(Sink sink, Term term_179, Term term_88, Term term_21)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_7 :
			{
				...
				/* #X=term */ /* #XS=term */ sink.copy(term_21.ref());
				return true;
			}
		}
	...
	final public static boolean _M_Insert(Sink sink, Term term_108, Term term_85)
	{
		if (sink.context().sd++ < 256)
		{
			label_132 :
			{
				...
				/* #XS=term */
				sink.start(_M_Cons);
				sink.copy(term_108.ref());
				sink.copy(term_85.ref());
				sink.end();
				return true;
			}
		}
	...
	final public static boolean _M_IWrapFoldlP(Sink sink, Variable var_26, Variable var_80, Term term_71, Term term_91, Term term_162)
	{
		if (sink.context().sd++ < 256)
		{
			label_1 :
			{
				...
				Variable jvar_50 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_76, jvar_50});
				Term jterm_84;
				{
					BufferSink buffer_14 = sink.context().makeBuffer();
					buffer_14.use(jvar_76);
					jterm_84 = buffer_14.term();
				}
				Term jterm_35;
				{
					BufferSink buffer_68 = sink.context().makeBuffer();
					buffer_68.use(jvar_50);
					jterm_35 = buffer_68.term();
				}
				sink.substitute(term_71.ref(), new Variable[]
					{var_26, var_80}, new Term[]
					{jterm_84, jterm_35});
				sink.copy(term_91.ref());
				sink.copy(term_162.ref());
				sink.end();
				return true;
			}
		}
		...
		if (sink.context().sd++ < 256)
		{
			...
			label_147 :
			{
				...
				Term jterm_97;
				{
					...
					buffer_84.use(jvar_48);
					jterm_97 = buffer_84.term();
				}
				Term jterm_69;
				{
					BufferSink buffer_22 = sink.context().makeBuffer();
					buffer_22.use(jvar_61);
					jterm_69 = buffer_22.term();
				}
				sink.substitute(term_0.ref(), new Variable[]
					{var_7, var_14}, new Term[]
					{jterm_97, jterm_69});
				Term jterm_39;
				{
					BufferSink buffer_60 = sink.context().makeBuffer();
					buffer_60.copy(sub_92.ref());
					jterm_39 = buffer_60.term();
				}
				Term jterm_283;
				{
					BufferSink buffer_49 = sink.context().makeBuffer();
					buffer_49.copy(term_72.ref());
	...
	final public static boolean _M_PickFirst(Sink sink, Term term_57, Variable var_67, Term term_78)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_68 :
			{
				...
				Variable jvar_213 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_213});
				Term jterm_82;
				{
					BufferSink buffer_53 = sink.context().makeBuffer();
					buffer_53.use(jvar_213);
	...
	final public static boolean _M_Reverse(Sink sink, Term term_198)
	{
		if (sink.context().sd++ < 256)
		{
			label_73 :
			{
				...
				Variable jvar_109 = sink.context().makeVariable("x");
				sink.binds(new Variable[]
					{jvar_78, jvar_109});
				sink.start(_M_Insert);
				sink.use(jvar_78);
	...
	final public static boolean _M_Null(Sink sink, Term term_199)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_149 :
			{
				...
				/* #H=sub */
				Term sub_108 = term_199.sub(1).ref();
	...
	final public static boolean _M_IsEmpty(Sink sink, Term term_488)
	{
		if (sink.context().sd++ < 256)
		{
			...
			label_89 :
			{
				...
				/* #=sub */
				Term sub_107 = term_488.sub(1).ref();
